...
// import { SkeletonCard } from "../home-page/OurServices/SkeletonCard";
...
// export default function BeforeAfter({ lang, initialMainServices, initialSubServices }) {
...
//             <BeforeAfterSkeleton nCard key={i} />
//           ))
...
import BeforeAfterClient from "./dynamic/BeforeAfterClient";

export default async function BeforeAfter({ lang }) {

  const mainServices = await findAllService(lang);
  const subServices = await findAllSubServices(lang);

  // sirf 5 main services
